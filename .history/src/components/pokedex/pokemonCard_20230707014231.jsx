...
<article className="">
  ...
  {/* Tipo de ataque */}
  <h6 className="bg-gray-800 text-white  text-center capitalize w-full flex-grow">{stat.stat.name}</h6>
  {/* Fuerza del ataque */}
  <span className=" text-center rounded ${pokeLinearGradients[pokemon?.types[0]?.stat.stat.name]} text-white w-full flex-grow">{stat.base_stat}</span>
</div>
