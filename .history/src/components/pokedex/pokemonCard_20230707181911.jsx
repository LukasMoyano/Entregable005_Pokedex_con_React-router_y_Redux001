...
const PokemonCard = ({ pokemonUrl }) => {
  ...
  return (
    <article className="">
      ...
      {/* Sección NOMBRE */}
      <section>
        <h3 className="before:content-[attr(before)]">
          {pokemon?.name}
        </h3>

        {/* TYPE */}
        <span className="text-2xl flex items-center justify-center ">Type</span>
        <h5 className="text-xl text-center text-capital"> {formatTypesPokemon(pokemon?.types)}</h5>
        <hr />
      </section>
