  ...
  return (
    ...
    >
      <div className=" grid px-2 flex-col items-center justify-center rounded-2xl align-center">
        ...
        <header
          className={`relative h-[100px] w-full mb-6 ${pokeLinearGradients[pokemon?.types[0]?.type?.name]
            }`}
        >
          <div className="absolute left-1/2 -translate-x-1/2 -bottom-4 h-[80px] aspect-square ">
