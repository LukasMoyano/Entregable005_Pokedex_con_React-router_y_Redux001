...
const PokemonCard = ({ pokemonUrl }) => {
 ...
 // const formatTypesPokemon = (types = []) => { const nameTypes = types.map((type) => type.type.name) const titleTypes = nameTypes.join(" / ") return titleTypes || [] };
...
<article className="">
  ...
  <section>
    ...
    <h3 className="mx-auto items-center capitalize hover:uppercase text-center font-bold text-3xl my-7">{pokemon?.name}</h3>
    <h5 className="text-center font-serif text-sm">{formatTypesPokemon(pokemon?.types)}</h5>
