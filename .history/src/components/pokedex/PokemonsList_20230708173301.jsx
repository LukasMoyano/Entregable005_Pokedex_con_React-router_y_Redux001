...
<ul className=" dislsplay-flex-col grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
  {visiblePokemons.map((pokemon) => (
    <li style={{maxWidth: "250px"}} key={pokemon.url} className="w-261 h-383 flex-shrink-0">
