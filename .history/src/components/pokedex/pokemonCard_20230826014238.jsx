...
const PokemonCard = ({ pokemonUrl }) => {
  ...
  return (
    <section
      className={`border-2  relative rounded-bl-2xl rounded-br-2xl hover:[animation:scale-105]`}

    >



      <article className=" grid px-2 flex-col items-center justify-center rounded-2xl align-center  first-letter:
