...
const PokemonCard = ({ pokemonUrl }) => {
  ...
  return (
<section 
  // className={`border-[${pokeLinearGradients[pokemon?.types[0]?.type?.name]}] rounded-lg `}

>



    <article className="grid h-[383px] w-[261px] flex flex-col items-center justify-center rounded-2xl">
      ...
      >
        <div className="absolute px-16 -bottom-10 flex items-center justify-center">
          <img
      ...
      <section className="font-family-family-Press+Start+2P font-press+Start">
