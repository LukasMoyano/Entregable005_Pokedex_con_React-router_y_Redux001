  ...
  return (
    <article className="">
      <section
        ...
        <div className="absolute p-12 -bottom-18">
          <img
      ...
      {/* Sección NOMBRE */}
      <section>
        <h3 className="mt-10 items-center capitalize hover:uppercase text-center font-bold text-3xl my-7">
          {pokemon?.name}
        </h3>

        {/* TYPE */}
        <span className="capitalize text-2xl flex items-center justify-center ">Type</span>
