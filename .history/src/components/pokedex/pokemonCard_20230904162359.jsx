...
const PokemonCard = ({ pokemonUrl }) => {
  ...
  return (
    <Link
      ...
      className={`text-center border-[20px] border-[${borderStyledPkemonByType[pokemon?.types[0]?.type?.name]}] relative rounded-bl-2xl rounded-br-2xl hover:[animation:scale-105]`}
    >
