  ...
  return (
    <section>
      ...
      {pokemons.map((pokemon) => (
        <PokemonCard className="bg-white shadow-lg rounded-lg p-4" key={pokemon.url} pokemonUrl={pokemon.url} /> // Crea una tarjeta de PokemonCard con la URL del Pokemon como prop
      ))}
    </section>
  );
};
