...
<section   className={`grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 ph-40 ${pokeLinearGradients[pokemon?.types[0]?.type?.name]}
  border border-black rounded-lg`}>
    ...
    <article className="grid">
      ...
      >
        <div className="absolute px-16 -bottom-10 inset-0 flex items-center justify-center">
          <img
