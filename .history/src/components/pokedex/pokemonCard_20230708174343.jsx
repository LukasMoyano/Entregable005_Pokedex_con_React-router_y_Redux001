...
//padre de lista
  //lista desodendala a una li 

  return (
<ul className="margin-0 padding-0 flex flex-col flex-wrap w-full">
        {visiblePokemons.map((pokemon) => (
          <li
            style={{ maxWidth: "250px" }}
            key={pokemon.url}
            className="w-250 h-383"
          >
            <div className="w-full h-full bg-white">
              <PokemonCard pokemonUrl={pokemon.url} />
    <article className="pokemons-container grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-4 justify-center items-center">
