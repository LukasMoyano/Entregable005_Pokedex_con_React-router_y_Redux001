...
const PokemonsList = ({ pokemons }) => {
  ...
  return (
    <section>
      ...
      <div className="mb-50 flex justify-center mt-4">
        <button
          ...
          if (
            ...
            return (
              <button
                ...
                className={`mr-2 px-2 py-1 rounded ${currentPage === index + 1
            ...
            return (
              // Botón deshabilitado como indicador de puntos suspensivos
              <button
                key={index}
                disabled
                className="mr-2 px-2 py-1 rounded bg-red-500"
