...
<article className="">
  ...
  {/* Tipo de ataque */}
  <h6 className="px-6 bg-gray-800 text-white  text-center text-justify capitalize w-full flex-grow">{stat.stat.name}</h6>
  {/* Fuerza del ataque */}
  <span className="py-0.5 px-7 rounded bg-gray-500 text-white w-full flex-grow">{stat.base_stat}</span>
</div>
