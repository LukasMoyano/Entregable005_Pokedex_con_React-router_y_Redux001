...
const BarProgressStat = () => {
  return (
    ...
    <div className="h-6 bg-ice rounded-xl mx-1 shadow-2xl">
        <div style={{width: getPorcentBarProgress(stat.value)}} className="h-full bg-gradient-to-r from-electric/50 to-fighting/50 rounded-xl shadow-2xl "></div>
    </div>
</article>
  )
}
