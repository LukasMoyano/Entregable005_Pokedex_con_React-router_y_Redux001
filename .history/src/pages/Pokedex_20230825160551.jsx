...
const Pokedex = () => {
  ...
  return (
    <main className="Absolute">
      ...
      <section className="items-center space-x-3 p-4">
        {/* Bienvenida al entrenador */}
        <blockquote data-arwes-global-palette="error" className="text-center text-6xl">
          <p className="text-xl">
            <span className="text-red-500">Hello</span>, <spa>Welcome {nameTrainer}</spa>, here you can find your favorite Pokemon.
          </p>
        </blockquote>
