...
const Pokedex = () => { 
  ...
  const {currentType, pokemonsByName, pokemonsByType, types, pokemons, nameTrainer, namePokemon, handleSubmit, handleChangeType, currentType, handleChange, setCurrentPage, currentPage, totalPages,  handleNextPage, handlePreviousPage} = usePokedex();
