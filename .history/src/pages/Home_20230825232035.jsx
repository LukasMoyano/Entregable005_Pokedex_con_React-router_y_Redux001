...
const Home = () => {
  ...
  // Inicializa la función navigate para realizar la navegación entre rutas.
  ...
  return (
    <main className="row-gap column-gap  grid grid-rows-[1fr_auto] min-h-screen bg-[neutral-200]">
      {/* Sección superior */}
