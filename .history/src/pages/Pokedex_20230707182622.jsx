    ...
    <main>
      ...
      <form onSubmit={handleSubmit}>
        <div className="mx-2">
          ...
          <button
            type="submit"
            className="flex-shrink-0 bg-red-500 hover:bg-red-600 active:bg-red-700 focus:outline-none focus:ring focus:ring-violet-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-2 mb-0 active:scale-95 duration-300"
          >
            Search
          </button>
        </div>
